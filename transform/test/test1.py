...
from transformations.Transformation import Transformation as tf
...
def test2():
# Set up the points
    points = [tf.Point2D(1, 2), tf.Point2D(2, 4), tf.Point2D(), tf.Point2D(6, 12)]
    for p in points:
        print(p)
...
def test3():
# Set up the points
    points = [tf.Point2D(4, 4), tf.Point2D(1, 6), tf.Point2D(), tf.Point2D(2, 2)]
    for p in points:
        print(p)
